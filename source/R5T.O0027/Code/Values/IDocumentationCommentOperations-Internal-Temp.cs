...
namespace R5T.O0027.Internal
{
    public partial interface IDocumentationCommentOperations : IValuesMarker
    {
        ...
        public MemberDocumentation Expand_InheritdocElements2(
            ...
            ITextOutput textOutput)
        {
            // The main issue with expansion is how to handle cycles, where A references B, but B references A.
            ...
            // A hashset (which is a cheap stack) of inheritdoc element references will be maintained, and any inheritdoc crefs in the hashset will not be recursed upon.
